	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 298.0, 42.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 25.0, 91.0, 15.0 ],
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.0, 182.0, 85.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 4.0, 69.0, 23.0 ],
					"text" : ".control"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.0, 285.0, 52.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 134.0, 50.0, 18.0 ],
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 255.0, 52.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.0, 104.0, 52.0, 18.0 ],
					"text" : "resolution"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 689.0, 188.0, 110.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1109.0, 175.0, 44.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 79.0, 137.0, 55.0, 18.0 ],
					"text" : "contrast"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1016.0, 100.0, 52.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 79.0, 104.0, 52.0, 18.0 ],
					"text" : "brightness"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1014.0, 202.0, 70.0, 18.0 ],
					"text" : "contrast $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 1014.0, 177.0, 85.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 79.0, 151.0, 43.0, 18.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1014.0, 145.0, 83.0, 18.0 ],
					"text" : "brightness $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 1014.0, 120.0, 85.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 79.0, 120.0, 43.0, 18.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 849.0, 159.0, 95.0, 18.0 ],
					"text" : "refreshmode $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 849.0, 136.0, 85.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 151.0, 54.0, 18.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 687.0, 158.0, 133.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 687.0, 136.0, 85.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.0, 120.0, 54.0, 18.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -3.0, -3.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.98291, 134.157959, 66.77401, 70.767006 ],
					"presentation" : 1,
					"presentation_rect" : [ 70.982941, 44.157959, 58.77401, 60.767006 ],
...
,
					"patching_rect" : [ 501.700043, 186.087982, 19.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 432.833038, 294.938965, 602.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 432.833038, 115.938965, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.635294, 0.431373, 0.431373, 1.0 ],
					"fontname" : "Gill Sans",
					"fontsize" : 10.0,
					"id" : "obj-11",
					"maxclass" : "message",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.833038, 164.938965, 31.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 62.938965, 31.0, 16.0 ],
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.121569, 1.0, 0.207843, 1.0 ],
					"fontname" : "Gill Sans",
					"fontsize" : 10.0,
					"id" : "obj-10",
					"maxclass" : "message",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.833038, 163.938965, 31.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 43.938965, 31.0, 16.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 369.50354, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 6.649658, 131.0, 163.497177 ]
				}
