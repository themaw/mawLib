{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 897.0, 204.0, 946.0, 775.0 ],
		"bgcolor" : [ 0.14902, 0.14902, 0.129412, 1.0 ],
		"bglocked" : 1,
		"defrect" : [ 897.0, 204.0, 946.0, 775.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.texture #1 @name render_fbo @dim 3072 768 @mode static",
					"patching_rect" : [ 264.0, 474.0, 349.0, 20.0 ],
					"fontsize" : 11.595187,
					"id" : "obj-72",
					"numoutlets" : 2,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 131.5, 332.0, 827.5, 332.0 ]
				}
