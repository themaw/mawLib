{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 163.0, 65.0, 1024.0, 698.0 ],
		"bgcolor" : [ 0.14902, 0.14902, 0.129412, 1.0 ],
		"bglocked" : 1,
		"defrect" : [ 163.0, 65.0, 1024.0, 698.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "list of devices and inputs",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 334.0, 497.0, 150.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-10",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 12.0, 455.0, 150.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-6",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 3,
					"patching_rect" : [ 123.0, 290.0, 184.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-4",
					"outlettype" : [ "bang" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"patching_rect" : [ 469.0, 390.0, 80.0, 90.0 ],
					"numoutlets" : 1,
					"id" : "obj-74",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 469.0, 601.0, 145.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-75",
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"numinlets" : 5,
					"patching_rect" : [ 123.0, 453.0, 219.0, 64.0 ],
					"numoutlets" : 1,
					"id" : "obj-60",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"patching_rect" : [ 636.0, 390.0, 80.0, 90.0 ],
					"numoutlets" : 1,
					"id" : "obj-58",
					"args" : [  ],
					"name" : "maw.jit.plane-pos-size.maxpat",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 636.0, 601.0, 145.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-27",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 123.0, 211.0, 20.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-14",
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 123.0, 256.0, 65.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-15",
					"outlettype" : [ "bang" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"numinlets" : 1,
					"patching_rect" : [ 120.0, 594.0, 96.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-29",
					"outlettype" : [ "bang", "" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"id" : "obj-7",
					"args" : [ "maw.jit.videoplane", "http://dev.minneapolisartonwheels.org/projects/show/mawlib", "Helper abstractions for playing video on a rendered plane." ],
...
, 			{
		...
		"parameters" : 		{
			"obj-74::obj-129" : [ "aspectX[1]", "aspectX", 0 ],
			"obj-58::obj-129" : [ "aspectX", "aspectX", 0 ],
			"obj-74::obj-135" : [ "size[1]", "posX", 0 ],
			"obj-58::obj-128" : [ "aspectY", "aspectY", 0 ],
			"obj-74::obj-128" : [ "aspectY[1]", "aspectY", 0 ],
			"obj-58::obj-131" : [ "posX", "posX", 0 ],
			"obj-74::obj-70" : [ "posY[1]", "posY", 0 ],
			"obj-58::obj-135" : [ "size", "posX", 0 ],
			"obj-58::obj-70" : [ "posY", "posY", 0 ],
			"obj-74::obj-131" : [ "posX[1]", "posX", 0 ]
		}
