	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hidden" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 623.0, 342.0, 72.0, 20.0 ],
					"id" : "obj-6",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 611.0, 318.0, 90.0, 20.0 ],
					"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"minimum" : 1,
					"patching_rect" : [ 560.0, 318.0, 50.0, 20.0 ],
					"maximum" : 159,
					"id" : "obj-10",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 560.0, 342.0, 60.0, 18.0 ],
					"id" : "obj-11",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Note: Kernel values must be odd and between between 1 and 160 pixels.  Invalid values are rounded down to the nearest odd number.",
					"linecount" : 4,
					"fontsize" : 12.0,
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"patching_rect" : [ 761.0, 113.0, 246.0, 62.0 ],
					"id" : "obj-127",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numinlets" : 1,
					"fontname" : "Trebuchet MS",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "maw.jit.gaussian",
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 539.0, 382.0, 99.0, 20.0 ],
					"id" : "obj-121",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 45.0, 382.0, 99.0, 20.0 ],
					"id" : "obj-78",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 163.0, 661.0, 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"hidden" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"background" : 1,
					"numinlets" : 0,
					"args" : [ "maw.jit.gaussian", "http://dev.minneapolisartonwheels.org/projects/show/mawlib", "An external for the OpenCV Gaussian Blurring function." ],
					"numoutlets" : 0
				}
