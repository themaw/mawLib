{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 460.0, 143.0, 1024.0, 698.0 ],
		"bgcolor" : [ 0.14902, 0.14902, 0.129412, 1.0 ],
		"bglocked" : 1,
		"defrect" : [ 460.0, 143.0, 1024.0, 698.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 367.0, 496.0, 150.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-10",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 41.0, 455.0, 150.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-6",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 3,
					"patching_rect" : [ 158.0, 289.0, 184.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-4",
					"outlettype" : [ "bang" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"patching_rect" : [ 504.0, 389.0, 80.0, 90.0 ],
					"numoutlets" : 1,
					"id" : "obj-74",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 504.0, 600.0, 145.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-75",
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"numinlets" : 5,
					"patching_rect" : [ 158.0, 452.0, 219.0, 64.0 ],
					"numoutlets" : 1,
					"id" : "obj-60",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"patching_rect" : [ 671.0, 386.0, 80.0, 90.0 ],
					"numoutlets" : 1,
					"id" : "obj-58",
					"args" : [  ],
					"name" : "maw.jit.plane-pos-size.maxpat",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 671.0, 600.0, 145.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-27",
					"outlettype" : [ "jit_matrix", "" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 158.0, 210.0, 20.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-14",
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"numinlets" : 1,
					"patching_rect" : [ 155.0, 593.0, 96.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-29",
					"outlettype" : [ "bang", "" ],
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"id" : "obj-7",
					"args" : [ "maw.jit.videoplane-render", "http://dev.minneapolisartonwheels.org/projects/show/mawlib", "Helper abstractions for playing video on a rendered plane." ],
