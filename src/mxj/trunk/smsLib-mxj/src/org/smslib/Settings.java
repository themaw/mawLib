...
public class Settings
{
	...
	/**
	 * Sync message processor interval:
	 * If CNMI detection fails, SMSLib will emulate and still act as an asynchronous reader, by implementing a background polling technique and pushing the read messages via the callback methods. The following value defined the interval of the simulated background reader.
	 */
	public int SYNC_MSG_PROC_INTERVAL = 30000;
